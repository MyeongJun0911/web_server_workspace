            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form name="memberRegisterFrm" method="post" class="space-y-4 md:space-y-6">
                    ...
                    <fieldset>
                        ...
                        <div class="inline-flex items-center mr-4">
                            <input id="hobby-1" type="checkbox" name="hobby" value="운동" checked class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" >
                    ...
                    <button type="submit" class="w-full bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">회원가입</button>
